...
# Model with 5 hidden layers and 100 Nodes per layer
# 
...
root_logdir = 'tf-logs'
logdir = 'tmp/dnn_mnist_study2-{}/'.format(root_logdir, now)
...
file_writer = tf.summary.FileWriter(logdir, graph = g2) 
...
with tf.Session(graph = g2) as sess:
    ...
    save_path = saver.save(sess, "./my_model_final_study2.ckpt")
...
print('change directory to current directory of this program and type:',
      '\n\n   tensorboard --logdir tmp/dnn_mnist5_nodes-tf-logs')
