...
# Model with 2 hidden layers and 100 Nodes per layer
# 
...
root_logdir = 'tf-logs'
logdir = 'tmp/dnn_mnist_study1-{}/'.format(root_logdir, now)
...
with tf.Session(graph = g) as sess:
    ...
    save_path = saver.save(sess, "./my_model_final_study1.ckpt")
...
print('change directory to current directory of this program and type:',
      '\n\n   tensorboard --logdir tmp/dnn_mnist-tf-logs')
